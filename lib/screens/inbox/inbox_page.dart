                ...
                child: PageView(
                  ...
                  children: [
                    BlocBuilder<NotificationCubit, NotificationState>(
                                            buildWhen: (current, previous) => current.notifications != previous.notifications,
                    ...
                    BlocBuilder<NotificationCubit, NotificationState>(
                      buildWhen: (current, previous) => current.unreadNotifications != previous.unreadNotifications,
                      builder: (context, state) {
                        if (state.status == NotificationStatus.loading) {
                          return const Center(
                              child: CircularProgressIndicator());
                    ...
                    BlocBuilder<NotificationCubit, NotificationState>(
                                            buildWhen: (current, previous) => current.readNotifications != previous.readNotifications,
